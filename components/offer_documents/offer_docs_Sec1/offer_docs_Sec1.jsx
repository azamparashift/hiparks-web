        ...
        <div className="flex flex-col justify-between mt-[15px] lg:mt-[15px] md:flex-row 1280:items-center items-start">
          <div className="max-w-[565px] mb-[15px] lg:mb-[0px] relative">
            ...
            <img
              ...
              className="absolute md:w-[130px] md:right-[-35px] md:top-[17px] 1280:w-[195px] 1280:right-[-20px] 1280:top-[36px] 1440:w-[260px] 1440:right-[-80px] 1440:top-[28px] w-[100px] right-[-20px] top-[13px] "
            />
          </div>
