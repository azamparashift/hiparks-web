            ...
            <div className="fix relative w-full lg:pt-[70px] lg:pb-[86px] pt-[45px] pb-[45px]">
                ...
                <div className="flex gap-[5px] lg:gap-[50px] 1280:gap-[60px] 1366:gap-[60px] justify-between flex-col lg:flex-row">
                    <div className="w-[312px] md:w-[240px] 1280:w-[312px]  mb-[15px] lg:mb-[0px] relative">
                        <h1 className="1280:text-[56px] 1280:leading-[66px] 1280:tracking-[-3.04px] lg:text-[37px] lg:leading-[43px] lg:tracking-[-2.04px]  text-[30px] leading-[36px] tracking-[-1px]  bw-r">Financial <br></br><span className="bw-m">Results</span></h1>
                    </div>
                    <div className="md:w-[auto] lg:w-[700px] 1280:w-[898px] lg:text-center ">
                        <div className="flex m-[0px] lg:m-[auto] w-[65%]">
                            <form className="w-[100%] align-center">
                                <div className="dropdown_dv lg:w-[100%]">
                                    <select className="cursor-pointer  bw-r w-[100%] border-b-[1px] border-[#CDCDCD] md:text-[25px] text-[18px] text-[#000000] md:pb-[10px] pb-[5px]">
                                ...
                                <button type="submit" className="cursor-pointer bw-r lg:text-[19px] text-[14px] text-white bg-[#000] py-[7px] px-[20px] lg:py-[15px] lg:px-[25px]  mt-[20px]">Download PDF</button>
                            </form>
                        </div>
